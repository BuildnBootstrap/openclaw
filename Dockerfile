...
RUN --mount=type=cache,id=s/8515d34f-acc2-46eb-8f21-b76145fb872f-openclaw-pnpm-store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/8515d34f-acc2-46eb-8f21-b76145fb872f-openclaw-bookworm-apt-cache,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/8515d34f-acc2-46eb-8f21-b76145fb872f-openclaw-bookworm-apt-lists,target=/var/lib/apt,sharing=locked \
    apt-get update && \
